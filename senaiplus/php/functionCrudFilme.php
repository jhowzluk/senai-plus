                        ...
                        .'<form method="POST" action="php/salvaFilme.php?id='.$campo['idFilme'].'" enctype="multipart/form-data">'
                            .'<div class="modal-body">'
                                ...
                                .'<div class="mb-3">'
                                    ...
                                    .'<textarea class="form-control" name="nSinopseFilme" id="iSinopseFilme" rows="3">'.$campo['sinopse'].'</textarea>'
                                .'</div>'
                                .'<div class="mb-3">'
                                ...
                                .'<div class="mb-3">'
                                    ...
                                    .'<textarea class="form-control" name="nElencoFilme" id="iElencoFilme" rows="3">'.$campo['elenco'].'</textarea>'
                                .'</div>' 
                                .'<br>'
                                .'<div class="mb-3">'
                                ...
                                .'<div class="row">'
                                    .'<div class="col-md-4">'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero1" id="iGenero1" '.validaGenero($campo['idFilme'],1).'>'
                                            .'<label for="iGenero1" class="form-label">&nbsp;Ação</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero2" id="iGenero2" '.validaGenero($campo['idFilme'],2).'>'
                                            .'<label for="iGenero2" class="form-label">&nbsp;Aventura</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero3" id="iGenero3" '.validaGenero($campo['idFilme'],3).'>'
                                            .'<label for="iGenero3" class="form-label">&nbsp;Anime</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero4" id="iGenero4" '.validaGenero($campo['idFilme'],4).'>'
                                            .'<label for="iGenero4" class="form-label">&nbsp;Comédia</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero5" id="iGenero5" '.validaGenero($campo['idFilme'],5).'>'
                                            .'<label for="iGenero5" class="form-label">&nbsp;Documentário</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero6" id="iGenero6" '.validaGenero($campo['idFilme'],6).'>'
                                            .'<label for="iGenero6" class="form-label">&nbsp;Drama</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero7" id="iGenero7" '.validaGenero($campo['idFilme'],7).'>'
                                            .'<label for="iGenero7" class="form-label">&nbsp;Fantasia</label>'
                                        .'</div>'
                                    .'</div>'   
                                    .'<div class="col-md-4">'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero8" id="iGenero8" '.validaGenero($campo['idFilme'],8).'>'
                                            .'<label for="iGenero8" class="form-label">&nbsp;Terror</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero9" id="iGenero9" '.validaGenero($campo['idFilme'],9).'>'
                                            .'<label for="iGenero9" class="form-label">&nbsp;Infantil</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero10" id="iGenero10" '.validaGenero($campo['idFilme'],10).'>'
                                            .'<label for="iGenero10" class="form-label">&nbsp;Suspense</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero11" id="iGenero11" '.validaGenero($campo['idFilme'],11).'>'
                                            .'<label for="iGenero11" class="form-label">&nbsp;Mistério</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero12" id="iGenero12" '.validaGenero($campo['idFilme'],12).'>'
                                            .'<label for="iGenero12" class="form-label">&nbsp;Romance</label>'
                                        .'</div>'
                                        .'<div class="mb-3">'
                                            .'<input type="checkbox" name="nGenero13" id="iGenero13" '.validaGenero($campo['idFilme'],13).'>'
...
function validaGenero($idFilme,$idGenero){
    $check = '';
